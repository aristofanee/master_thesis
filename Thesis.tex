...
Laser Induced Breakdown Spectroscopy (LIBS) is a powerful analytical method that allows for the detection of the elemental composition of a target sample. It is commended for its balance between precision, speed, and high sensitivity that permits us to identify small traces of impurities. Beyond all of this, its high versatility made it a common choice for a plurality of applications.
\\
We employed a specific calibration-free approach of LIBS to investigate the presence of contaminants in optical glasses due to grinding and polishing. All the processes involved in chemical-mechanical polishing leave surface defects that can influence the optical properties of the material, it is of interest for the industry to study and describe the contamination process to understand its characteristics and minimize its effect.
\\
...
\\
In Chapter~\ref{ch:glass_manufacturing} the theoretical description of the post-processes of glass manufacturing is presented, complete with all details on the both the grinding and polishing phases.
\\
...
\input{1_experimental_techniques.tex}

\chapter{Glass Manufacturing}
\input{2_glass_manufacturing.tex}

\chapter{Research Premises}
\input{3_research_premises.tex}

\chapter{Experimental Results}
\input{5_experimental_results.tex}
